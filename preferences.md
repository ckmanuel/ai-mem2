...
- Preferred shell: (to be confirmed)
- Code editor: (to be confirmed)

## Document & Output Preferences
- Default output format: (to be confirmed)
- Citation style: (to be confirmed)
- Number formatting: (to be confirmed)

## Coding Style
- Preferred languages: (to be confirmed)
- Naming conventions: (to be confirmed)
