# Archived Decisions — Session 1 (2026-09-08)

Older decision log entries from session 1. Moved here to keep
`decisions.md` lean. Full rationale is preserved; only location
changed. If you need to supersede one of these, write a new entry in
`../decisions.md` referencing it by title and date.
